...
<div class="headline">
	...
	<a href="Controller?commandToController=GO_TO_STANDART_PRE_SEARCH" style="text-decoration: none; margin-left: 100px;">
		<div class="lineconteiner">
			<div style="float: left;">
				<img src="resources/pictures/logo.png" style="margin: 20px; height: 50px; width: 50px;" />
			</div>
			<div style="float: left;">
	...
	<div class="lineconteiner">
		...
		<form action="Controller" method="post">
			<input type="hidden" name="commandToController" value="GO_TO_STANDART_PRE_SEARCH" />
			<button class="zapchast_button">Запчасти</button>
		</form>
		<form action="Controller" method="post">
			<input type="hidden" name="commandToController" value="GO_TO_DOCUMENTATION" />
