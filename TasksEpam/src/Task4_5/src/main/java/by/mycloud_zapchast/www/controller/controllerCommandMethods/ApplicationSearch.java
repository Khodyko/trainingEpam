...
/**
*	Search with summ of sector's application in current depo in chosen year
*	PageCounterFilter Before this command
*	SecurityFilter Before this command (user must have a session)
**/
...
public class ApplicationSearch implements Command {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/**Throws this params of searching to DB*/
