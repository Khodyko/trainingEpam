...
public abstract class WireDevice extends ElectricDevice {
	...
	public void turnOn() {
		if (isTurnOn) {
			...
			isTurnOn = true;
			controller
					.showMessage("Plug of this " + this.getClass().getSimpleName() + " put into the socket. It works!");
		}
	}
	...
	public void turnOff() {
		...
		if (isTurnOn) {
			...
			controller.showMessage(
					"Plug of this " + this.getClass().getSimpleName() + " take out of the socket. It doesn't work!");
