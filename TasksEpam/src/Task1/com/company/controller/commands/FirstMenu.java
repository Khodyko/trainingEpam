...
public class FirstMenu extends Command {
	...
	public void execute() {
		...
		nameOfChoiceAndCommand.put(
				"Calculate Power of electric devices(with current filters \n    (only for \"turnOn\" devices)",
				new CalculatePowerEDevices());
